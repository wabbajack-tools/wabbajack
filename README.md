...
Wabbajack will not only index your entire MO2 folder but also your entire Game folder and will try to also match files from your downloads folder with your game folder. These matched files will end up in a `Game Folder files` folder in the MO2 subdirectory after a user installs your list. Let's look at an example for better understanding:
