...
public partial class NativeNexusLoginView : ReactiveUserControl<NativeNexusLoginVM>
{
    public NativeNexusLoginView()
    {
        InitializeComponent();

        NexusImage.Source = (DrawingImage)Application.Current.Resources["NexusLogo"];
