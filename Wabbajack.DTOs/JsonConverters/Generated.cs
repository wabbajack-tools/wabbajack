    ...
    switch (value) {
      ...
      case Wabbajack.DTOs.DownloadStates.VectorPlexus v1:
        JsonSerializer.Serialize(writer, v1, options);
         return;
      case Wabbajack.DTOs.DownloadStates.DeprecatedLoversLab v2:
        JsonSerializer.Serialize(writer, v2, options);
         return;
      case Wabbajack.DTOs.DownloadStates.GameFileSource v3:
        JsonSerializer.Serialize(writer, v3, options);
         return;
      case Wabbajack.DTOs.DownloadStates.GoogleDrive v4:
        JsonSerializer.Serialize(writer, v4, options);
         return;
      case Wabbajack.DTOs.DownloadStates.Http v5:
        JsonSerializer.Serialize(writer, v5, options);
         return;
      case Wabbajack.DTOs.DownloadStates.Manual v6:
        JsonSerializer.Serialize(writer, v6, options);
         return;
      case Wabbajack.DTOs.DownloadStates.MediaFire v7:
        JsonSerializer.Serialize(writer, v7, options);
         return;
      case Wabbajack.DTOs.DownloadStates.Mega v8:
        JsonSerializer.Serialize(writer, v8, options);
         return;
      case Wabbajack.DTOs.DownloadStates.ModDB v9:
        JsonSerializer.Serialize(writer, v9, options);
         return;
      case Wabbajack.DTOs.DownloadStates.Nexus v10:
        JsonSerializer.Serialize(writer, v10, options);
         return;
      case Wabbajack.DTOs.DownloadStates.TESAlliance v11:
        JsonSerializer.Serialize(writer, v11, options);
         return;
      case Wabbajack.DTOs.DownloadStates.WabbajackCDN v12:
