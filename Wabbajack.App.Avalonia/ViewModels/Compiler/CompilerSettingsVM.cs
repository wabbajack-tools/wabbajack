...
/// <summary>
/// The WPF app's CompilerSettingsVM: <see cref="CompilerSettings" /> as reactive properties the compiler screens
/// bind to, and back again.
/// </summary>
...
#pragma warning disable CS0618 // Carried as the WPF app carries it.
...
#pragma warning restore CS0618
    ...
    /// <summary>The main (default) profile.</summary>
    [Reactive] public partial string Profile { get; set; } = "";

    /// <summary>Secondary profiles to include in the modlist.</summary>
    [Reactive] public partial string[] AdditionalProfiles { get; set; } = Array.Empty<string>();

    /// <summary>All profiles to be added to the compiled modlist.</summary>
    ...
    /// <summary>This file, or files in these folders, are automatically included if they match no other step.</summary>
    [Reactive] public partial HashSet<RelativePath> NoMatchInclude { get; set; } = new();

    /// <summary>These files are inlined into the modlist.</summary>
    [Reactive] public partial HashSet<RelativePath> Include { get; set; } = new();

    /// <summary>These files are ignored when compiling the modlist.</summary>
