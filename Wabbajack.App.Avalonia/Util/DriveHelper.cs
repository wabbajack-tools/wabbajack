...
/// <summary>
///     The WPF app's DriveHelper, unchanged: fixed drives, and which physical disk (and so SSD or HDD) each
///     drive letter sits on, read through WMI. Windows only, as WMI is.
/// </summary>
