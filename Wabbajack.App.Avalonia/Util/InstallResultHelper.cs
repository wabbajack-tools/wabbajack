...
/// <summary>The title and sentence the installer's result screen shows for each way an install can end.</summary>
public static class InstallResultHelper
{
    ...
    public static string GetDescription(this InstallResult result)
    {
        return result switch
        {
            ...
            InstallResult.DownloadFailed => "The modlist installation has failed because one or more required files could not be sourced.",
